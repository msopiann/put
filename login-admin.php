...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($username) || empty($password)) {
        ...
        if ($user && isset($user['is_admin']) && $user['is_admin']) {
            ...
            $error_message = "Data yang dimasukkan salah atau kamu bukan admin.";
        }
    }
}
$title = "Login Admin";
    ...
    <div class="w-50 mx-auto mt-5 h-100 justify-content-center align-items-center">
        ...
        <ul class="nav nav-pills nav-justified mb-3" id="ex1" role="tablist">
            <li class="nav-item" role="presentation">
                <a class="nav-link active" href="login-admin.php">Login</a>
            </li>
            <li class="nav-item" role="presentation">
            ...
            <div class="tab-pane fade show active" id="pills-login" role="tabpanel" aria-labelledby="tab-login">
                <form action="login-admin.php" method="POST">
                    ...
                    <div class="text-center">
                        <p>Not a member? <a href="register-admin.php">Register</a></p>
                    </div>
                </form>
            </div>
        </div>
